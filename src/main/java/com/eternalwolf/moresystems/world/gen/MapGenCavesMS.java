package com.eternalwolf.moresystems.world.gen;
...
public class MapGenCavesMS extends MapGenBase {
	
	private Block block;
	private Block blockLava = Blocks.LAVA;
	
	public MapGenCavesMS(Block block, Block blockLava) {
		this.block = block;
		this.blockLava = blockLava;
	}
	
	public MapGenCavesMS(Block block) {
		this.block = block;
	}
