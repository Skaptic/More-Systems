...
import com.eternalwolf.moresystems.biomes.genlayers.apollo.GenLayerApollo;
...
public class BiomeProviderApollo extends BiomeProvider {
	...
	protected BiomeProviderApollo() {
		body = CelestialBodies.planetApollo;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderApollo(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerApollo.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderApollo(World world) {
