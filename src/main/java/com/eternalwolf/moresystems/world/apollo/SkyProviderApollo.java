...
public class SkyProviderApollo extends IRenderHandler
{
    ...
    public SkyProviderApollo(IGalacticraftWorldProvider apolloProvider)
    {
        this.sunSize = 10.5F * apolloProvider.getSolarSize();
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        f10 = this.sunSize;
        mc.renderEngine.bindTexture(SkyProviderApollo.polluxTexture);
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderApollo.veneraTexture);
        worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
