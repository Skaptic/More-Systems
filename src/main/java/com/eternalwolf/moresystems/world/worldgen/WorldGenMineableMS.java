package com.eternalwolf.moresystems.world.worldgen;
...
public class WorldGenMineableMS extends MSWorldGenMaster {
	
	private IBlockState oreBlock;
	private IBlockState fillBlock;
	private int numberOfBlocks;
	
	public WorldGenMineableMS(Block oreBlock, Block fillBlock, int numberOfBlocks) {
		this.oreBlock = oreBlock.getDefaultState();
		this.numberOfBlocks = numberOfBlocks;
		this.fillBlock = fillBlock.getDefaultState();
	}
	
	public WorldGenMineableMS(Block oreBlock, Block fillBlock, EnumOreGenMS oreGen) {
		this.oreBlock = oreBlock.getDefaultState();
