...
public abstract class BiomeDecoratorBase extends BiomeDecorator {
	...
	protected void generateOre(WorldGenerator generator, EnumOreGenMS oreGen, World world, Random rand) {
	...
	protected void generateLapis(WorldGenerator generator, EnumOreGenMS oreGen, World world, Random rand) {
